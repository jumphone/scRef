...
b=read.table('../../Habib_exp_sc_mat_cluster_original.txt',header=T,sep='\t')
c=read.table('../../Habib_exp_sc_mat_cluster_merged.txt',sep='\t',header=T)
...
print('remove')
print('ARI')
r=which(!c[,2] %in% c('Neurons', "OTHER"))
